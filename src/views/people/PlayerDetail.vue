      ...
      <nav class="flex items-start px-4 py-3 sm:px-6 lg:px-8 xl:hidden" aria-label="Breadcrumb">
        <ol role="list" class="flex items-center space-x-4">
          ...
          <li class="flex items-center">
            ...
            <router-link :to="{ name: 'TeamsDetail', params: { id: player.currentTeam.id } }" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ player.currentTeam.teamName }}</router-link>
          </li>
          <li class="flex items-center">
            <ChevronRightIcon class="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
